...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-agrismart-hackathon-core-key-2024')
...
INSTALLED_APPS = [
    ...
    # AgriSmart AI Micro-Apps (AI/ML Domain Layer)
    'disease_detection',
    'crop_recommendation',
    'irrigation',
    'weather',
...
# Database
# Note: Django handles AI orchestration; SQLite is used for local auth/admin cache while MongoDB is primary data store
DATABASES = {
    'default': {
